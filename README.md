...
The demo shows a clock, today's date, and a converter, with Decimal, Binary and Hexadecimal alongside for comparison. Hardcore mode hides the numbers and names.
